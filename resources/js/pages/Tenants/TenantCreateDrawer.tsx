                    ...
                    <div className="flex-1 overflow-auto p-6">
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="rounded-lg border-l-4 border-l-orange-500 p-4">
                                ...
                                {firstNameValidationError && <p className="mt-1 text-sm text-red-600">{firstNameValidationError}</p>}
                            </div>
                            ...
                            <div className="rounded-lg border-l-4 border-l-emerald-500 p-4">
                                ...
                                {lastNameValidationError && <p className="mt-1 text-sm text-red-600">{lastNameValidationError}</p>}
                            </div>

...
import { PaymentPlanFormData, DropdownData } from '@/types/PaymentPlan';
...
export default function PaymentPlanCreateDrawer({ dropdownData, open, onOpenChange, onSuccess }: Props) {
    ...
    return (
        <Drawer open={open} onOpenChange={onOpenChange} modal={false}>
            <DrawerContent size="half" title="Create New Payment Plan">
                                ...
                                >
                                    <PopoverTrigger asChild>
                                        ...
                                        >
                                            ...
                                            {data.dates
                                                ? format(parse(data.dates, 'yyyy-MM-dd', new Date()), 'PPP')
                                                : 'Pick a date'}
                                        </Button>
                                    </PopoverTrigger>

...
export default function Edit({ moveOut, tenants, unitsByTenant, tenantsData }: Props) {
    ...
    const [availableUnits, setAvailableUnits] = useState<string[]>(
        moveOut.tenants_name && unitsByTenant[moveOut.tenants_name] ? unitsByTenant[moveOut.tenants_name] : []
    );
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <CardTitle className="text-2xl">Edit Move-Out Record</CardTitle>
